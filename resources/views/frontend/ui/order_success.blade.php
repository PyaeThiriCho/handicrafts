...
<div class="container py-5 text-center reveal">
    ...
    <div class="mb-4">
        <i class="fas fa-check-circle fa-4x mb-3" style="color: var(--color-gold);"></i>
        <h3 class="fw-bold" style="font-family: var(--font-serif);">Thank You!</h3>
    ...
    <div class="mt-4">
        <a href="{{ route('homepage') }}" class="btn btn-brand-outline rounded-pill px-4">Return Home</a>
    </div>
</div>

            ...
            <div class="card border-0 shadow-lg p-4 p-md-5 rounded-4 auth-card">
                ...
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <div class="text-end mb-4">
                        <a href="#" class="text-brand small text-decoration-none">Forgot Password?</a>
                    </div>
                    ...
                    <div class="text-center">
                        <p class="small mb-0">Don't have an account?
                            <a href="{{ route('register') }}" class="text-brand fw-bold text-decoration-none">Register Here</a>
                        </p>
                    </div>
                </form>
            </div>
